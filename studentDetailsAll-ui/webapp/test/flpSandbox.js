		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#studentDetailsAlluistudentDetailsAllui-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"studentDetailsAlluistudentDetailsAllui-display": {
								"semanticObject": "studentDetailsAlluistudentDetailsAllui",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=studentDetailsAllui.studentDetailsAllui",
									"url": sap.ui.require.toUrl("studentDetailsAllui/studentDetailsAllui")
								}
							}
						}
					}
